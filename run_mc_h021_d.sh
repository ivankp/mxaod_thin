...
mc16d.aMCnloPy8_bbH125_yb2.MxAODDetailed.p3472.h021.root \
mc16d.aMCnloPy8_bbH125_ybyt.MxAODDetailed.p3472.h021.root \
mc16d.aMCnloHwpp_tWH125_yt_plus1.MxAODDetailed.p3472.h021.root
do
  ./bin/mxaod_thin \
    -i ${dir}/$f \
    -o ~/space/thin/h021_mc16d/$(sed -r 's/mc16d\.([^.]+).+/\1/' <<< $f).root
done
